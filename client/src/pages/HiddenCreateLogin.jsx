...
export default function HiddenCreateLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: `✓ Login created successfully for ${formData.email} with ${formData.role} role and ${permissionText}. User saved to database.`,
      });
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-elevated">
          <CardHeader className="text-center space-y-3">
            ...
            <CardTitle className="text-2xl md:text-3xl">Create Hidden Login Access</CardTitle>
            <CardDescription className="text-base">
              Assign user credentials and manage permissions with No GST option
            </CardDescription>
          </CardHeader>
